...
![Termux-zsh-pic](Termux-zsh-pic.png)
...
-   Install autocomplete plugin (from [marlonrichert](https://github.com/marlonrichert/zsh-autocomplete))
-   Installs auto-updater for oh-my-zsh, plugins and themes (from [tamcore](https://github.com/tamcore/autoupdate-oh-my-zsh-plugins)). 
